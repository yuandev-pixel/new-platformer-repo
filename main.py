...
while True:
    ...
    if  pygame.mouse.get_pressed()[0] and edit:
        ...
        "flip-x":False,
        "flip-y":False,
        "chunk-x":round((real_mouse_tile_pos[0]-player.camera_x)//10),
        "chunk-y":round((real_mouse_tile_pos[1]-player.camera_y)//10),
        }
    ...
    #绘制玩家
    player.player_idle.draw(screen,player.flip,False)
